...
| **Year** | **Pub.** | **Title**          | **Links**        |
| :------: | :------: | :----------------------------------------------------------- |  :----------------------------------------------------------- |
| 2024  | TPAMI | **ZoomNeXt: A Unified Collaborative Pyramid Network for Camouflaged Object Detection**   <br> <sup><sub>*Youwei Pang, Xiaoqi Zhao, Tian-Zhu Xiang, Lihe Zhang, Huchuan Lu*</sub></sup>  | [arXiv](https://arxiv.org/abs/2310.20208)/[Official](https://ieeexplore.ieee.org/document/10568374)/<br>[Code](https://github.com/lartpang/ZoomNeXt)
